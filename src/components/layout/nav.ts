...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/notificaciones-csj", label: "Cédulas CSJ", icon: "flag", roles: ["ADMIN", "JURIDICO"], feature: "juridico" },
  ...
  { href: "/configuracion", label: "Configuración", icon: "settings", roles: ["ADMIN", "JURIDICO"] },
];
